              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    <li class="rd-nav-item"><a class="rd-nav-link" href="inicio">Home</a>
                    </li>
                ...
                <div class="row row-50 row-md-60 row-lg-80">
                  <div class="col-12">
                    <article class="post post-modern box-xxl">
                      <div class="post-modern-panel">
                        ...
                        <div>
                          <time class="post-modern-time" datetime="2019-09-08">August 9, 2019</time>
                        </div>
                      </div>
                      <h3 class="post-modern-title">Top 5 Reasons to Regularly Maintain Your Tractor</h3>
                      <div class="post-modern-figure"><img src="../resources/static/images/post-9-800x394.jpg" alt="" width="800" height="394"/>
                      </div>
                    ...
                    <article class="quote-classic quote-classic-2">
                      <div class="quote-classic-text">
                        <div class="q">Maintaining your tractor at FixIt guarantees that you will be ready for every agricultural season.</div>
                      </div>
                    </article>
                    <p>Ac turpis egestas maecenas pharetra convallis. Dignissim enim sit amet venenatis urna cursus. Ac tortor dignissim convallis aenean et. Quam vulputate dignissim suspendisse in est ante in. Porttitor eget dolor morbi non arcu risus quis varius. Pretium viverra suspendisse potenti nullam. Suspendisse faucibus interdum posuere lorem ipsum dolor sit.</p>
                    <div class="single-post-bottom-panel">
                      <div class="group-sm group-justify">
                        <div>
                          <div class="group-sm group-tags"><a class="link-tag" href="#">News</a><a class="link-tag" href="#">Repair</a><a class="link-tag" href="#">Tips</a></div>
                        </div>
                        <div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="row row-30">
                      <div class="col-sm-6">
                        <!-- Post Classic-->
                        <article class="post post-classic box-md"><a class="post-classic-figure" href="blogpost"><img src="../resources/static/images/post-7-370x239.jpg" alt="" width="370" height="239"/></a>
                          <div class="post-classic-content">
                            <div class="post-classic-time">
                              <time datetime="2019-09-08">August 9, 2019</time>
                            </div>
                            <h4 class="post-classic-title"><a href="blogpost">Popular Replacement Parts for Tractors and Combines</a></h4>
                            <p class="post-classic-text">Id neque aliquam vestibulum morbi blandit. Neque sodales ut etiam sit amet nisl purus in. Magna eget est lorem. </p>
                          </div>
                        </article>
                      </div>
                      <div class="col-sm-6">
                        <!-- Post Classic-->
                        <article class="post post-classic box-md"><a class="post-classic-figure" href="blogpost"><img src="../resources/static/images/post-8-370x239.jpg" alt="" width="370" height="239"/></a>
                          <div class="post-classic-content">
                            <div class="post-classic-time">
                              <time datetime="2019-09-08">August 9, 2019</time>
                            </div>
                            <h4 class="post-classic-title"><a href="blogpost">Why You Should Trust FixIt with Tractor Repair &amp; Maintenance</a></h4>
                            <p class="post-classic-text">Lectus sit amet est placerat in egestas erat imperdiet sed. Risus nullam eget felis eget nunc lobortis mattis aliquam.</p>
                          </div>
                        </article>
                      </div>
                    </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="box-comment">
                      <div class="unit flex-column flex-sm-row unit-spacing-md">
                        <div class="unit-left"><a class="box-comment-figure" href="#"><img src="../resources/static/images/user-1-119x119.jpg" alt="" width="119" height="119"/></a></div>
                        <div class="unit-body">
                          <div class="group-sm group-justify">
                            <div>
                          ...
                          <p class="box-comment-text">Sed blandit libero volutpat sed cras ornare arcu dui. Facilisis sed odio morbi quis commodo odio aenean. Tortor dignissim convallis aenean et tortor at risus viverra adipiscing.</p>
                        </div>
                      </div>
                      <div class="box-comment">
                        <div class="unit flex-column flex-sm-row unit-spacing-md">
                          <div class="unit-left"><a class="box-comment-figure" href="#"><img src="../resources/static/images/user-2-119x119.jpg" alt="" width="119" height="119"/></a></div>
                          <div class="unit-body">
                            <div class="group-sm group-justify">
                              <div>
                                <div class="group-xs group-middle">
                            ...
                            <p class="box-comment-text">Commodo quis imperdiet massa tincidunt nunc pulvinar sapien. In arcu cursus euismod quis viverra. Volutpat lacus laoreet non curabitur gravida arcu. </p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="box-comment">
                      <div class="unit flex-column flex-sm-row unit-spacing-md">
                        <div class="unit-left"><a class="box-comment-figure" href="#"><img src="../resources/static/images/user-3-119x119.jpg" alt="" width="119" height="119"/></a></div>
                        <div class="unit-body">
                          <div class="group-sm group-justify">
                            <div>
                              <div class="group-xs group-middle">
                          ...
                          <p class="box-comment-text">Cursus risus at ultrices mi tempus imperdiet nulla. Id diam maecenas ultricies mi eget. Cursus vitae congue mauris rhoncus. Dolor purus non enim praesent. </p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-lg-4 col-xl-3">
              <div class="aside row row-30 row-md-50 justify-content-md-between">
                <div class="aside-item col-12">
                  <div class="team-info box-sm"><a class="team-info-figure" href="#"><img src="../resources/static/images/user-4-123x123.jpg" alt="" width="123" height="123"/></a>
                    <h6 class="team-info-title"><a href="#">Sam Harison</a></h6>
                    <p class="team-info-text">Sed eleifend, lacus nec bibendum pulvinar, nibh</p>
                  </div>
                  <!-- RD Search Form-->
                  <form class="rd-search form-search" action="searchresults" method="GET">
                    <div class="form-wrap">
                ...
                <div class="aside-item col-sm-6 col-md-5 col-lg-12">
                  ...
                  <ul class="list-categories">
                    ...
                    <li><a href="#">Tips</a><span class="list-categories-number">(5)</span></li>
                    <li><a href="#">Tractor Repair</a><span class="list-categories-number">(8)</span></li>
                  </ul>
                </div>
                <div class="aside-item col-sm-6 col-lg-12">
                  ...
                  <div class="row row-20 row-lg-30 gutters-10">
                    <div class="col-6 col-lg-12">
                      ...
                      <article class="post post-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-lg-row align-items-lg-center">
                          <div class="unit-left"><a class="post-minimal-figure" href="blogpost"><img src="../resources/static/images/post-mini-1-260x254.jpg" alt="" width="260" height="254"/></a></div>
                          <div class="unit-body">
                            <p class="post-minimal-title"><a href="blogpost">Where to Buy Bearings and A / C Parts</a></p>
                    ...
                    <div class="col-6 col-lg-12">
                      ...
                      <article class="post post-minimal">
                        <div class="unit unit-spacing-sm flex-column flex-lg-row align-items-lg-center">
                          <div class="unit-left"><a class="post-minimal-figure" href="blogpost"><img src="../resources/static/images/post-mini-2-260x254.jpg" alt="" width="260" height="254"/></a></div>
                          <div class="unit-body">
                            <p class="post-minimal-title"><a href="blogpost">How to Maintain Your Tractor: Top 8 Tips</a></p>
                            <div class="post-minimal-time">
                              <time datetime="2019-03-15">March 15, 2019</time>
                            </div>
                          </div>
                ...
                <div class="aside-item col-sm-6 col-md-5 col-lg-12">
                  ...
                  <div class="group-sm group-tags"><a class="link-tag" href="#">News</a><a class="link-tag" href="#">Tips</a><a class="link-tag" href="#">Repair</a><a class="link-tag" href="#">Combines</a><a class="link-tag" href="#">Maintenance</a><a class="link-tag" href="#">Agricultural</a></div>
                </div>
                <div class="aside-item col-sm-6 col-lg-12">
