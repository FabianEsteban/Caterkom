          ...
          <div class="row row-30 justify-content-center bordered-1">
            <div class="col-sm-4">
              <div class="counter-classic">
                ...
                <h5 class="counter-classic-title">Supported models of<br class="d-none d-sm-block"> Tractors</h5>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="counter-classic">
                <h1 class="counter-classic-number"><span class="counter">270</span>
                </h1>
                <div class="counter-classic-decor"></div>
                <h5 class="counter-classic-title">National <br class="d-none d-sm-block">partners</h5>
              </div>
            </div>
            <div class="col-sm-4">
              <div class="counter-classic">
                <h1 class="counter-classic-number"><span class="counter">350</span>
                </h1>
                <div class="counter-classic-decor"></div>
            ...
            <div class="row row-30 justify-content-center">
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  <h2 class="counter-modern-number"><span class="counter">270</span>
                  </h2>
              ...
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  <h2 class="counter-modern-number"><span class="counter">50</span>
                  </h2>
                  <div class="counter-modern-decor"></div>
