    ...
    <div class="page">
      ...
      <section class="section section-sm bg-default text-md-left">
        <div class="container">
          ...
          <div class="group-xs-2 group-middle">
            <div class="button button-lg button-icon button-icon-left button-secondary button-zakaria"><span class="icon mdi mdi-arrow-right"></span>Read more</div>
      ...
      <section class="section section-sm section-last bg-default text-md-left">
        <div class="container">
          ...
          <div class="group-xs-2 group-middle">
            <div class="button button-lg button-icon button-icon-left button-shadow button-secondary button-zakaria"><span class="icon mdi mdi-arrow-right"></span>Read more</div>
              ...
              <div class="col-md-10 col-lg-3 col-xl-4 wow fadeInRight">
                <div class="inset-xl-right-70">
                  ...
                  <div class="row row-10 gutters-10" data-lightgallery="group">
                    ...
                    <div class="col-4 col-sm-2 col-lg-4">
                      <!-- Thumbnail Minimal--><a class="thumbnail-minimal" href="../resources/static/images/grid-gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="../resources/static/images/grid-gallery-5-178x1783.jpg" alt="" width="178" height="1783"/></a>
                    </div>
                    <div class="col-4 col-sm-2 col-lg-4">
