...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
      <section class="section section-single context-dark bg-image" style="background-image: url(../resources/static/images/bg-404.jpg);">
        <div class="section-single-inner">
          ...
          <div class="section-single-main">
            <div class="container">
              ...
              <h3 class="font-weight-light text-spacing-100">Page Not Found</h3><a class="button button-lg button-secondary button-zakaria" href="inicio">Go to home page</a>
            </div>
          </div>
