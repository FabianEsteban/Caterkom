      ...
      <section class="breadcrumbs-custom">
        <div class="parallax-container" data-parallax-img="../resources/static/images/bg-about.jpg">
          <div class="breadcrumbs-custom-body parallax-content context-dark">
            <div class="container">
              <h2 class="breadcrumbs-custom-title">Calls to action</h2>
            </div>
          </div>
        </div>
        <div class="breadcrumbs-custom-footer">
          <div class="container">
            <ul class="breadcrumbs-custom-path">
              ...
              <li class="active">Calls to action</li>
            </ul>
          </div>
        </div>
      </section>
      <!-- Calls to action-->
      <section class="section section-xl bg-brown-1">
        <div class="container">
          <h3 class="text-spacing-100">Special <span class="font-weight-light">Offer</span>
          </h3>
          <h6 class="font-weight-light">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h6><a class="button button-lg button-shadow-2 button-primary button-zakaria" href="#">Learn more</a>
        </div>
      </section>

      <!-- Calls to action-->
      <section class="section section-xl bg-gray-3 text-md-left">
        <div class="container">
          <div class="row row-30 align-items-center justify-content-md-between">
            <div class="col-md-6 col-lg-8">
              <h3 class="text-spacing-100">Special <span class="font-weight-light">Offer</span>
              </h3>
              <h6 class="font-weight-light">Condimentum vitae sapien pellentesque habitant morbi tristique senectus et netus.</h6>
            </div>
            <div class="col-md-auto"><a class="button button-lg button-shadow-2 button-primary button-zakaria" href="#">Learn more</a></div>
          </div>
        </div>
      </section>
