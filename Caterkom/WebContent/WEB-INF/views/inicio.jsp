        ...
        <div class="container">
          ...
          <div class="row row-xl row-xxl-2 row-30 row-md-40 row-lg-50 align-items-center">
            <div class="col-md-5 col-xl-4">
              <div class="row row-30 row-md-40 row-lg-50 bordered-2">
                <div class="col-sm-6 col-md-12">
                  <article class="box-icon-nancy box-icon-nancy-right text-center text-lg-right wow fadeInLeft">
                    <div class="unit unit-spacing-sm flex-column flex-lg-row-reverse">
                      <div class="unit-left">
                        <div class="box-icon-nancy-svg"><span class="icon linearicons-menu3 icon-65"></span>
                        </div>
                      </div>
                      <div class="unit-body">
                        <h4 class="box-icon-nancy-title"><a href="#">100% Warranty </a></h4>
                        <p class="box-icon-nancy-text">We provide a full warranty on all tractor repair and maintenance services that FixIt’s team provides.</p>
                      </div>
                    </div>
                  </article>
                </div>
                <div class="col-sm-6 col-md-12">
                  <article class="box-icon-nancy box-icon-nancy-right text-center text-lg-right wow fadeInLeft" data-wow-delay=".1s">
                    <div class="unit unit-spacing-sm flex-column flex-lg-row-reverse">
                      <div class="unit-left">
                        <div class="box-icon-nancy-svg"><span class="icon icon-65 linearicons-wrench"></span>
                        </div>
                      </div>
                      <div class="unit-body">
            ...
            <div class="col-md-5 col-xl-4">
              <div class="row row-30 row-md-40 row-lg-50 bordered-2">
                <div class="col-sm-6 col-md-12">
                  <article class="box-icon-nancy box-icon-nancy-left text-center text-lg-left wow fadeInRigth">
                    <div class="unit unit-spacing-sm flex-column flex-lg-row">
                      <div class="unit-left">
                        <div class="box-icon-nancy-svg"><span class="icon icon-65 linearicons-power"></span>
                        </div>
                      </div>
                      <div class="unit-body">
                ...
                <div class="col-sm-6 col-md-12">
                  <article class="box-icon-nancy box-icon-nancy-left text-center text-lg-left wow fadeInRight" data-wow-delay=".1s">
                    <div class="unit unit-spacing-sm flex-column flex-lg-row">
                      <div class="unit-left">
                        <div class="box-icon-nancy-svg"><span class="icon icon-65 span icon icon-65 linearicons-cog"></span>
                        </div>
                      </div>
                      <div class="unit-body">
              ...
              <div class="tabs-custom tabs-jean" id="tabs-1">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="tabs-1-1">
                    <div class="box-info-creative">
                      <h5 class="box-info-creative-title"><a href="#">since 1999, we have been delivering quality tractor repair services</a></h5>
                      <div class="box-info-creative-text">FixIt was founded with the intention of providing agricultural machinery repair services of the top level so that even small farmers could have their equipment fully functional.</div><a class="link-classic box-info-creative-link" href="#">Read more</a>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="tabs-1-2">
                    <div class="box-info-creative">
                      <h5 class="box-info-creative-title"><a href="#">Being a global leader in providing quality tractor repair services</a></h5>
                      <div class="box-info-creative-text">Our company aims to be your preffered partner in tractor and combine repairs by achieving excellence in everything we do. We also strive to remain customer-oriented.</div><a class="link-classic box-info-creative-link" href="#">Read more</a>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="tabs-1-3">
                    <div class="box-info-creative">
                      <h4 class="box-info-creative-title"><a href="#">We aim to help our customers maintain their agricultural machinery</a></h4>
                      <div class="box-info-creative-text">We help our customers succeed by providing premier repair & maintenance solutions for a wide variety of agricultural machinery through teamwork and professional excellence.</div><a class="link-classic box-info-creative-link" href="#">Read more</a>
                    </div>
                  </div>
                </div>
                <!-- Nav tabs-->
                <div class="nav-tabs-wrap">
                  <ul class="nav nav-tabs">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-toggle="tab">about us</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-2" data-toggle="tab">our vision</a></li>
          ...
          <div class="owl-carousel owl-style-10" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-dots="true" data-mouse-drag="false">
            <article class="team-creative wow slideInUp" data-wow-delay=".1s">
              ...
              <div class="team-creative-body">
                ...
                <p class="team-creative-text opacity-50">Richard has a wide experience in every field of tractor repair as he’s been in the industry for over 20 years.</p>
            ...
            <article class="team-creative wow slideInUp">
              <div class="team-creative-header"><a class="team-creative-figure" href="#"><img src="../resources/static/images/team-9-249x249.jpg" alt="" width="249" height="249"/></a>
                <div class="team-creative-decor"></div>
              </div>
              <div class="team-creative-body">
          ...
          <div class="owl-carousel owl-style-11" data-items="1" data-sm-items="2" data-margin="30" data-dots="true" data-autoplay="false">
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">I take my equipment to FixIt because their hourly rate is wonderful. When you take farm equipment in, it will be repaired in a timely manner.</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-carly-figure"><img src="../resources/static/images/user-10-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">I am so pleased with the service at FixIt. I explained the problem I had with my tractor and they had it repaired in a couple of hours.</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-carly-figure"><img src="../resources/static/images/user-11-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">From the time I walked in the door right up to my tractor’s delivery, everyone was friendly, courteous, helpful and answered all my questions.</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-carly-figure"><img src="../resources/static/images/user-5-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-carly-author">Christopher Martin</div>
                    <div class="quote-carly-status">Client</div>
                  </div>
                </div>
              </div>
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">Your technicians were extremely polite and thorough when I asked them to help me with the repair of my LA115 tractor. Thank you!</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-carly-figure"><img src="../resources/static/images/user-6-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-carly-author">Ashley Perez</div>
                    <div class="quote-carly-status">Client</div>
                  </div>
                </div>
              </div>
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">I’ve been FixIt’s regular client since their Day 1 in business. They take care of everything my tractor needs including even the smallest repairs.</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-carly-figure"><img src="../resources/static/images/user-7-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-carly-author">Michael Henderson</div>
                    <div class="quote-carly-status">Client</div>
                  </div>
                </div>
              </div>
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">I’m genuinely impressed by your level of service and customer commitment. You delivery exceptional tractor repair services. Thank you!</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-carly-figure"><img src="../resources/static/images/user-8-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-carly-author">Rose Perry</div>
                    <div class="quote-carly-status">Client</div>
                  </div>
                </div>
              </div>
