      ...
      <section class="section section-xxl bg-default">
        <div class="container">
          ...
          <div class="owl-carousel owl-style-11" data-items="1" data-sm-items="2" data-margin="30" data-dots="true" data-autoplay="false">
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">From the time I walked in the door right up to my tractorâ€™s delivery, everyone was friendly, courteous, helpful and answered all my questions.</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">Iâ€™ve been FixItâ€™s regular client since their Day 1 in business. They take care of everything my tractor needs including even the smallest repairs.</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
            ...
            <article class="quote-carly quote-carly-1">
              <div class="quote-carly-text">
                <div class="q">Iâ€™m genuinely impressed by your level of service and customer commitment. You delivery exceptional tractor repair services. Thank you!</div>
              </div>
              <div class="quote-carly-footer">
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
