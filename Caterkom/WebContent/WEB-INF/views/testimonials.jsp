...
<html class="wide wow-animation" lang="en">
  ...
  <body>
    ...
    <div class="page">
          ...
          <div class="row row-lg row-30 justify-content-center">
            <div class="col-sm-6">
              ...
              <article class="quote-modern">
                ...
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-modern-figure"><img src="../resources/static/images/user-5-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
            ...
            <div class="col-sm-6">
              ...
              <article class="quote-modern">
                ...
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-modern-figure"><img src="../resources/static/images/user-6-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
          ...
          <div class="row row-30 justify-content-center">
            <div class="col-xl-9">
              <div class="slick-quote">
                <!-- Slick Carousel-->
                <div class="slick-slider carousel-parent" id="carousel-parent-3" data-autoplay="true" data-swipe="true" data-items="1" data-child="#child-carousel-3" data-for="#child-carousel-3">
                  <div class="item">
                    <p class="quote-minimal-text">Cur galatae congregabo? Eheu, luba! Victrixs credere in gandavum! Primus sectam virtualiter perderes pulchritudine est. Cum tumultumque manducare, omnes fermiumes.</p>
                  </div>
                  <div class="item">
                    <p class="quote-minimal-text">Peritus voxs ducunt ad gluten. Deuss sunt demolitiones de bi-color caesium. Mensa de raptus clinias, carpseris extum! Demolitiones sunt seculas de barbatus sensorem.</p>
                  </div>
                  <div class="item">
                    <p class="quote-minimal-text">Historia pius poeta est. Cobaltums crescere! Xiphias neuter armarium est. Idoleum de azureus humani generis, resuscitabo xiphias! Varius eleates semper imitaris accola.</p>
                  </div>
                </div>
                <div class="slick-quote-nav">
                  <div class="slick-slider child-carousel" id="child-carousel-3" data-arrows="true" data-for="#carousel-parent-3" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="3" data-xl-items="3" data-xxl-items="3">
                    <div class="item">
                      <div class="quote-minimal-figure"><img src="../resources/static/images/user-7-87x87.jpg" alt="" width="87" height="87"/>
                      </div>
                      <div class="quote-minimal-author">Patrick Goodman</div>
                      <div class="quote-minimal-status">Client</div>
                    </div>
                    <div class="item">
                      <div class="quote-minimal-figure"><img src="../resources/static/images/user-8-87x87.jpg" alt="" width="87" height="87"/>
                      </div>
                      <div class="quote-minimal-author">Kate Smith</div>
                      <div class="quote-minimal-status">Client</div>
                    </div>
                    <div class="item">
                      <div class="quote-minimal-figure"><img src="../resources/static/images/user-9-87x87.jpg" alt="" width="87" height="87"/>
                      </div>
      ...
      <section class="section section-xxl bg-default">
        <div class="container">
          <h3 class="font-weight-regular">#3</h3>
          <div class="row row-lg row-30 justify-content-center">
            <div class="col-sm-6 col-lg-4">
              <!-- Quote Creative-->
              <article class="quote-creative">
                <div class="quote-creative-text">
                  <div class="q">Cum exsul crescere, omnes plasmatores visum fatalis</div>
                </div>
                ...
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-creative-figure"><img src="../resources/static/images/user-6-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-creative-author">Lisa Smith</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4">
              ...
              <article class="quote-creative">
                <div class="quote-creative-text">
                  <div class="q">Varius coordinatae interdum promissios vox</div>
                </div>
                <div class="quote-creative-rating"><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span></div>
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-creative-figure"><img src="../resources/static/images/user-10-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-creative-author">Mark Wilson</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4">
              ...
              <article class="quote-creative">
                <div class="quote-creative-text">
                  <div class="q">Sunt adelphises contactus fatalis, azureus.</div>
                </div>
                <div class="quote-creative-rating"><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span><span class="icon mdi mdi-star"></span></div>
                <div class="unit unit-spacing-sm flex-column flex-md-row align-items-center">
                  <div class="unit-left">
                    <div class="quote-creative-figure"><img src="../resources/static/images/user-11-62x62.jpg" alt="" width="62" height="62"/>
                    </div>
                  </div>
                  <div class="unit-body">
                    <div class="quote-creative-author">Jane Peterson</div>
                  </div>
                </div>
              </article>
            </div>
