            ...
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-modern">
                <div class="box-icon-modern-header">
                  ...
                  <div class="box-icon-modern-svg"><span class="icon linearicons-wrench icon-50 text-primary"></span>
                  </div>
                </div>
                <h4 class="box-icon-modern-title"><a href="#">Best Service</a></h4>
                <p class="box-icon-modern-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</p>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-modern">
                <div class="box-icon-modern-header">
                  <div class="box-icon-modern-count box-ordered-item"></div>
                  <div class="box-icon-modern-svg"><span class="icon linearicons-medal-empty icon-50 text-primary"></span>
                  </div>
                </div>
                <h4 class="box-icon-modern-title"><a href="#">Reputation</a></h4>
                <p class="box-icon-modern-text">Pulvinar elementum integer enim neque volutpat ac tincidunt. Lobortis scelerisque fermentum dui</p>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-modern">
                <div class="box-icon-modern-header">
                  <div class="box-icon-modern-count box-ordered-item"></div>
                  <div class="box-icon-modern-svg"><span class="icon linearicons-thumbs-up icon-50 text-primary"></span>
                  </div>
                </div>
                <h4 class="box-icon-modern-title"><a href="#">Safety</a></h4>
                <p class="box-icon-modern-text">Mi ipsum faucibus vitae aliquet nec ullamcorper sit amet. Ipsum consequat nisl vel pretium lectus quam</p>
              </article>
            </div>
            <div class="col-sm-6 col-lg-3">
              <article class="box-icon-modern">
                <div class="box-icon-modern-header">
                  <div class="box-icon-modern-count box-ordered-item"></div>
                  <div class="box-icon-modern-svg"><span class="icon linearicons-lifebuoy icon-50 text-primary"></span>
                  </div>
                </div>
                <h4 class="box-icon-modern-title"><a href="#">Security</a></h4>
                <p class="box-icon-modern-text">Sit amet nisl purus in mollis nunc. Sit amet luctus venenatis lectus magna fringilla urna</p>
              </article>
            </div>
          </div>
        </div>
            ...
            <div class="col-sm-6 col-lg-4">
              <article class="box-icon-creative">
                <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center">
                  ...
                  <div class="unit-body">
                    <h5 class="box-icon-creative-title"><a href="#">Free Diagnostics</a></h5>
                    <p class="box-icon-creative-text">Offering free tractor diagnotics</p>
                  </div>
                </div>
              </article>
            </div>
              ...
              <article class="box-icon-creative">
                <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center">
                  ...
                  <div class="unit-body">
                    ...
                    <p class="box-icon-creative-text">Providing top customer service</p>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-lg-4">
              <article class="box-icon-creative">
                <div class="unit flex-column flex-md-row flex-lg-column flex-xl-row align-items-md-center align-items-lg-start align-items-xl-center">
                  ...
                  <div class="unit-body">
                    <h5 class="box-icon-creative-title"><a href="#">High-quality parts</a></h5>
                    <p class="box-icon-creative-text">The best parts for your tractor</p>
                  </div>
                </div>
              </article>
            </div>
          ...
          <div class="row row-30">
            <div class="col-sm-6 col-md-4">
              <article class="box-icon-classic text-sm-left">
                <div class="unit flex-column flex-sm-row flex-md-column flex-xl-row">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"><span class="icon linearicons-wrench icon-50 text-primary"></span>
                    </div>
                  </div>
                  <div class="unit-body">
                    <h4 class="box-icon-classic-title"><a href="#">Best Service</a></h4>
                    <p class="box-icon-classic-text">Egestas fringilla phasellus faucibus scelerisque eleifend donec. Nisi quis eleifend quam adipiscing vitae proin</p>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-4">
              <article class="box-icon-classic text-sm-left">
                <div class="unit flex-column flex-sm-row flex-md-column flex-xl-row">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"><span class="icon linearicons-medal-empty icon-50 text-primary"></span>
                    </div>
                  </div>
                  <div class="unit-body">
                    <h4 class="box-icon-classic-title"><a href="#">Reputation</a></h4>
                    <p class="box-icon-classic-text">Malesuada fames ac turpis egestas maecenas. Amet porttitor eget dolor morbi. Faucibus pulvinar elementum</p>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-sm-6 col-md-4">
              <article class="box-icon-classic text-sm-left">
                <div class="unit flex-column flex-sm-row flex-md-column flex-xl-row">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"><span class="icon linearicons-thumbs-up icon-50 text-primary"></span>
                    </div>
                  </div>
                  <div class="unit-body">
                    <h4 class="box-icon-classic-title"><a href="#">Safety &amp; security</a></h4>
                    <p class="box-icon-classic-text">Aliquet lectus proin nibh nisl. Magnis dis parturient montes nascetur ridiculus mus</p>
                  </div>
                </div>
              </article>
            </div>
