              ...
              <div class="rd-navbar-main">
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="aboutus">Nosotros</a>
                    </li>
...
<!--                 </div> -->
        ...
        <div class="parallax-container" data-parallax-img="../resources/static/images/bg-about.jpg">
          <div class="breadcrumbs-custom-body parallax-content context-dark">
            <div class="container">
              ...
              <h6 class="breadcrumbs-custom-text">Condimentum vitae sapien pellentesque habitant morbi tristique senectus et <br class="d-none d-md-block">netus. Vitae suscipit tellus mauris a diam maecenas sed enim.</h6>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row row-40 row-md-60 justify-content-center align-items-xl-center">
            <div class="col-md-11 col-lg-6 col-xl-5">
              <!-- Quote Classic Big-->
              <article class="quote-classic-big inset-xl-right-30"><span class="quote-classic-small-text">Repairing tractors since 1999</span>
                <div class="heading-2 quote-classic-big-text">
                  <div class="q">Unas pocas palabras</div>
                </div>
              </article>
              <!-- Bootstrap tabs-->
              <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                ...
                <div class="nav-tabs-wrap">
                  <ul class="nav nav-tabs">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-toggle="tab">Nosotros</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-2" data-toggle="tab">Nuestra visión</a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-3" data-toggle="tab">Nuestra misión</a></li>
                  </ul>
                </div>
                <!-- Tab panes-->
              ...
              </div><a class="button button-lg button-shadow-2 button-primary button-zakaria" href="#">Contáctanos</a>
            </div>
            <div class="col-md-11 col-lg-6 col-xl-7">
              <div class="slick-slider-1 inset-xl-left-35">
                ...
                <div class="slick-slider carousel-parent" id="carousel-parent" data-items="1" data-autoplay="true" data-slide-effect="true" data-child="#child-carousel" data-for="#child-carousel">
                  <div class="item"><img src="../resources/static/images/about-1-634x373.jpg" alt="" width="634" height="373"/>
                  </div>
                  <div class="item"><img src="../resources/static/images/about-2-634x373.jpg" alt="" width="634" height="373"/>
                  </div>
                  <div class="item"><img src="../resources/static/images/about-3-634x373.jpg" alt="" width="634" height="373"/>
                  </div>
                  <div class="item"><img src="../resources/static/images/about-4-634x373.jpg" alt="" width="634" height="373"/>
                  </div>
                </div>
                <div class="slick-slider child-carousel slick-nav-1" id="child-carousel" data-items="2" data-sm-items="4" data-md-items="4" data-lg-items="4" data-xl-items="4" data-xxl-items="4" data-arrows="true" data-for="#carousel-parent">
                  <div class="item"><img src="../resources/static/images/about-1-143x114.jpg" alt="" width="143" height="114"/>
                  </div>
                  <div class="item"><img src="../resources/static/images/about-2-143x114.jpg" alt="" width="143" height="114"/>
                  </div>
                  <div class="item"><img src="../resources/static/images/about-3-143x114.jpg" alt="" width="143" height="114"/>
                  </div>
                  <div class="item"><img src="../resources/static/images/about-4-143x114.jpg" alt="" width="143" height="114"/>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- Counter Modern-->
      <section class="section parallax-container" data-parallax-img="../resources/static/images/parallax-2.jpg">
            ...
            <div class="row row-30 justify-content-center">
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  ...
                  <h6 class="counter-modern-title">National<br>partners</h6>
                </div>
              </div>
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  ...
                  <div class="counter-modern-decor"></div>
                  <h6 class="counter-modern-title">tractor<br>parts</h6>
                </div>
              </div>
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  ...
                  <div class="counter-modern-decor"></div>
                  <h6 class="counter-modern-title">Satisfied<br>clients</h6>
                </div>
              </div>
              <div class="col-6 col-sm-3">
                <div class="counter-modern">
                  ...
                  <div class="counter-modern-decor"></div>
                  <h6 class="counter-modern-title">professional<br>technicians</h6>
                </div>
              </div>
            </div>
          </div>
